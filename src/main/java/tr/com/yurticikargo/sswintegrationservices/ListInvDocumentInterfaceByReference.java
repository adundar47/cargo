...
/**
 * <p>Java class for listInvDocumentInterfaceByReference complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="listInvDocumentInterfaceByReference">
 *   &lt;complexContent>
 ...
 *         &lt;element name="docIdArray" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "listInvDocumentInterfaceByReference", propOrder = {
    "userName",
    "password",
    "language",
    "custParamsVO",
...
public class ListInvDocumentInterfaceByReference {
    ...
    protected List<String> docIdArray;
    ...
    /**
     * Gets the value of the docIdArray property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the docIdArray property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDocIdArray().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getDocIdArray() {
        if (docIdArray == null) {
            docIdArray = new ArrayList<String>();
        }
